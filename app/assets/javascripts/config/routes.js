var Routes = (function(railsRoutes) {
  ...
  return RouteSet;
})({"oauthAuthorization":"/oauth/authorize","oauthToken":"/oauth/token","oauthRevoke":"/oauth/revoke","oauthTokenInfo":"/oauth/token/info","user":"/user","users":"/users","sites":"/sites","site":"/sites/:id","root":"/admin","adminRoot":"/admin","adminLogin":"/admin/login","adminLogout":"/admin/logout"});
